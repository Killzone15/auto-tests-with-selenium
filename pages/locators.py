...
class ProductPageLocators:
    ...
    PRICE_IN_MESSAGE = (By.CSS_SELECTOR, '#messages > div.alert.alert-safe.alert-noicon.alert-info.fade.in > div '
                                         '> p:nth-child(1) > strong')
    NAME_PRODUCT_MAIN = (By.CSS_SELECTOR, '.col-sm-6.product_main h1')
    NAME_MESSAGE_PRODUCT = (By.CSS_SELECTOR, '#messages > div:nth-child(1) > div > strong')
